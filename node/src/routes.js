...
import GivenTypeCalibrationController from './app/Controllers/TipoDadoCalibracaoController';
...
routes.post('/typecalibration', GivenTypeCalibrationController.store);
